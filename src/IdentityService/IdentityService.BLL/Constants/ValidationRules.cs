...
namespace IdentityService.BLL.Constants
{
    public static class ValidationRules
    {
        ...
        public static string NameMinLenghtMessage = "Name should be greater then 6 characters";
        public static string NameMaxLenghtMessage = "Name should be less then 20 characters";
